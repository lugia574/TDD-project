...
export const Header = (props: Props) => {
  return <div className={clsx(`flex justify-between h-14`, layoutStyles.px ,props.className)}>
    <div className="flex items-center">
      <Link href={`/`}>
        <Image width={16} height={16} src={"/vercel.svg" } alt="home" className='mr-4'></Image>
      </Link>
    ...
    <div className='flex items-center'>
      ...
      <Link href={`/contents/post`} className='border-green-300 border-2 rounded-r-full rounded-l-full text-green-400 text-sm px-3 py-1 mr-2'>새 글 작성</Link>
      {
        true ? (
